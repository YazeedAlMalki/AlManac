...
/// Reads workout duration out of the shared `health_sample` table so
/// hydration recommendations can react to exercise without hydration owning
/// any health sync logic itself.
///
...
///
/// Ported unchanged from `claude/app-hydration-tracking-mpwsyv` — it never
/// referenced a user id or any hydration-specific table, so there was
/// nothing to adapt.
